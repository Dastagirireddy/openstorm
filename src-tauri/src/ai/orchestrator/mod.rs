...
mod tests {
    ...
    impl LlmProvider for MockProvider {
        ...
        async fn chat_completion(
            &self,
            _request: crate::ai::provider::ChatCompletionRequest,
        ) -> Result<crate::ai::provider::ChatCompletionResponse, crate::ai::provider::ProviderError> {
            Ok(crate::ai::provider::ChatCompletionResponse {
                id: "mock-1".to_string(),
                model: "mock-model".to_string(),
                choices: vec![crate::ai::provider::Choice {
                    index: 0,
                    message: crate::ai::provider::Message::Assistant {
                        content: Some("Mock response from sub-agent".to_string()),
                        tool_calls: None,
                    },
                    finish_reason: Some("stop".to_string()),
                }],
                usage: Some(crate::ai::provider::Usage {
                    prompt_tokens: 10,
                    completion_tokens: 5,
                    total_tokens: 15,
                }),
        ...
        async fn chat_completion_stream(
            &self,
            _request: crate::ai::provider::ChatCompletionRequest,
        ) -> Result<mpsc::Receiver<crate::ai::provider::ChatCompletionChunk>, crate::ai::provider::ProviderError> {
            let (tx, rx) = mpsc::channel(10);
            tokio::spawn(async move {
                let _ = tx.send(crate::ai::provider::ChatCompletionChunk {
                    id: "mock-1".to_string(),
                    model: "mock-model".to_string(),
                    choices: vec![crate::ai::provider::ChunkChoice {
                        index: 0,
                        delta: crate::ai::provider::Delta {
        ...
        async fn check_connection(&self) -> Result<bool, crate::ai::provider::ProviderError> {
            Ok(true)
        }
    }
