...
use crate::ai::legacy::providers::traits::{LlmProvider, ProviderError};
use crate::ai::legacy::providers::openai_compatible::provider::OpenAICompatibleProvider;
use crate::ai::legacy::providers::anthropic::provider::AnthropicProvider;
...
impl ProviderRegistry {
    ...
    pub fn list_providers() -> Vec<crate::ai::legacy::providers::traits::ProviderInfo> {
        let mut providers = presets::list_provider_infos();

        // Add Anthropic
        providers.push(crate::ai::legacy::providers::traits::ProviderInfo {
        ...
        providers.insert(
            0,
            crate::ai::legacy::providers::traits::ProviderInfo {
                id: "ollama".to_string(),
