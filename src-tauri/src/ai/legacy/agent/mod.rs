...
use crate::ai::legacy::context::{ContextManager, ProjectContext};
use crate::ai::legacy::cost_tracker::SharedCostTracker;
use crate::ai::legacy::embedding_store::EmbeddingStore;
use crate::ai::legacy::permissions::PermissionSystem;
use crate::ai::legacy::sandbox::Sandbox;
...
pub struct Agent {
    pub provider: Arc<dyn crate::ai::legacy::provider::LlmProvider>,
    pub model: String,
